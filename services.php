...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-icon">
                                <img src="assetss/img/icon/services-icon1.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-icon">
                                <img src="assetss/img/icon/services-icon2.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-icon">
                                <img src="assetss/img/icon/services-icon3.svg" alt="">
                            </div>
                            <div class="cat-cap">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-6 col-md-6">
                        <div class="single-offers">
                            <img src="assetss/img/gallery/offers1.png" alt="" class=" w-100">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="single-offers">
                            <img src="assetss/img/gallery/offers2.png" alt="" class=" w-100">
                            <div class="offers-caption text-center">
                                <div class="cat-icon">
                                    <img src="assetss/img/icon/offers-icon1.png" alt="">
                                </div>
                                <div class="cat-cap">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-offers">
                            <img src="assetss/img/gallery/offers4.png" alt="" class=" w-100">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="container">
            <section class="wantToWork-area" data-background="assetss/img/gallery/section_bg01.png">
                <div class="wants-wrapper w-padding2">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-5">
                            <a href="#" class="btn wantToWork-btn"><img src="assetss/img/icon/call2.png" alt=""> Learn More</a>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-xl-12 ">
                            ...
                            <div class="testmonial-nav text-center">
                                <div class="testmonial-thumb">
                                    <img src="assetss/img/gallery/testimonila1.png" alt="">
                                </div>
                                <div class="testmonial-thumb">
                                    <img src="assetss/img/gallery/testimonila2.png" alt="">
                                </div>
                                <div class="testmonial-thumb">
                                    <img src="assetss/img/gallery/testimonila3.png" alt="">
                                </div>
                                <div class="testmonial-thumb">
                                    <img src="assetss/img/gallery/testimonila2.png" alt="">
                                </div>
        ...
        <!--?  Map Area start  -->
        <div class="Map-area">
            <img src="assetss/img/gallery/Map.png" alt="" class="w-100">
        </div>
        <!-- Map Area End -->
    </main>
    <footer>
